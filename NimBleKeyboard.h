#ifndef ESP32_NIMBLE_KEYBOARD_H
#define ESP32_NIMBLE_KEYBOARD_H
#include "sdkconfig.h"
...
#define NIMBLE_KEYBOARD_VERSION_MINOR 0
#define NIMBLE_KEYBOARD_VERSION_REVISION 0
